...
import com.app.pixstory.databinding.AlertAddTitleBinding;
...
public class AddTitle {
    ...
    public static void addTitle(Activity activity, int position, TextView addCaption, TextView photoCredits,String type) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(activity,
                ...
                searchItem(activity, position, addCaption, photoCredits,type);
            }
        } else {
            searchItem(activity, position, addCaption, photoCredits,type);
        }
    ...
    public static void searchItem(Activity activity, final int position, TextView addCaption, TextView photoCredits,String type) {
        LayoutInflater inflater = (LayoutInflater) activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        if (inflater != null) {
            AlertAddTitleBinding binding = DataBindingUtil.inflate(inflater, R.layout.alert_add_title, null, false);
            ...
            {
                binding.addCaption.setText(addCaption.getText().toString());
                binding.photoCredits.setText(photoCredits.getText().toString());
            }

//            speech(activity, binding);
            binding.ok.setOnClickListener(view -> {
                addCaption.setText(Objects.requireNonNull(binding.addCaption.getText()).toString().trim());
