...
public class FAQsFragment extends BaseFragment<FragmentFaqsBinding, FAQsViewModel> implements FAQNavigator, FAQExpandableAdapter.AudioCallback, View.OnClickListener {
    ...
    @Override
    protected void getBinding(FragmentFaqsBinding binding) {
    ...
    protected void init() {
        ...
        mSpeechRecognizerIntent.putExtra(RecognizerIntent.EXTRA_CALLING_PACKAGE, Objects.requireNonNull(getContext()).getPackageName());
        SpeechRecognitionListener listener = new SpeechRecognitionListener();
        mSpeechRecognizer.setRecognitionListener(listener);

        textToSpeech = new TextToSpeech(getBaseActivity(), status -> {
    ...
    public void faqFetched(List<FAQResponse.Data> data) {
        ...
        if (data.size() > 0) {
            ...
            getBaseActivity().showToast("No answer found for your question");
        }
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.submit:
                if (Objects.requireNonNull(binding.ques.getText()).toString().trim().isEmpty()) {
                    getBaseActivity().showToast("Enter question");
                    return;
                }
    ...
    private void recordAudio() {
        ...
        Utils.setLocalImage(getBaseActivity(), binding.audio, R.drawable.ic_using_mic);
        ...
        Dexter.withActivity((Activity) getContext())
                ...
                .withListener(new PermissionListener() {
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        getBaseActivity().showSettingsDialog();
                    }
    ...
    private class SpeechRecognitionListener implements RecognitionListener {
        ...
        public void onEndOfSpeech() {
            Utils.setLocalImage(getBaseActivity(), binding.audio, R.drawable.ic_mic);
        }
        ...
        public void onResults(Bundle results) {
            ...
            if (matches != null && matches.size() > 0) {
                ...
                getBaseActivity().showToast("Speech not recognized.Try again!!!");
            }
        }
