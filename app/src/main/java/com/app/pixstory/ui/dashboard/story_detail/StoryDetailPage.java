...
public class StoryDetailPage extends BaseActivity<StoryDetailPageBinding, StoryDetailModel> implements StoryDetailNavigator {
    ...
    protected void init() {
        ...
        viewModel.getLoading().observe(this, o -> {
            if ((Boolean) o) {
                showSimmerLoader(STORY_VIEW_LOADER);
            } else {
                hideSimmerLoader();
            }
        });
    ...
    private void clickListener() {
        ...
        binding.cardStoryNarrative.favourites.setOnClickListener(this::onClick);
    ...
    private void onClick(View view) {
        if (view.getId() == R.id.next) {
            ...
            IS_TYPE = "challenge";
            binding.support.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_button));
            binding.challenge.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_white_black_25));
            binding.notes.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_button));
            ...
            IS_TYPE = "notes";
            binding.support.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_button));
            binding.challenge.setBackgroundDrawable(getResources().getDrawable(R.drawable.shape_button));
            ...
            GlobalMethods.intentMethod(this, InboxActivity.class);
        }
    }
    ...
    public void followStatusChanged(String message, int follow) {
        binding.cardUserProfile.follow.setText("Unfollow");
    }
    ...
    private void initializeData(Story story, List<StoryInterest> storyInterest, StoryData storyData) {
        ...
        BindingUtils.setStringPhotos(binding.cardUserProfile.profileImage, story.getProfileImage(), binding.cardUserProfile.progressBar);
        // story data
