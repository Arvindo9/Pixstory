...
public class SearchMemberDataSource extends PageKeyedDataSource<Integer, MemberData> {
    ...
    public SearchMemberDataSource(int pageId, String searchText, String searchType, String findInPage) {
        ...
        ApiClient.getClient().create(APIService.class)
                ...
                .enqueue(new Callback<PageSearchResponse>() {
                    ...
                    public void onResponse(Call<PageSearchResponse> call, Response<PageSearchResponse> response) {
                        ...
                        if (response.body() != null && response.body().getData().getUserData() != null) {
                            callback.onResult(response.body().getData().getUserData(), null, FIRST_PAGE + 1);
                        }
                    }
        ...
        ApiClient.getClient().create(APIService.class)
                ...
                .enqueue(new Callback<PageSearchResponse>() {
                    ...
                    public void onResponse(Call<PageSearchResponse> call, Response<PageSearchResponse> response) {
                        ...
                        if (response.body() != null && response.body().getData().getUserData() != null) {
                            callback.onResult(response.body().getData().getUserData(), adjacentKey);
                        }
                    }
    ...
    @Override
    public void loadAfter(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<Integer, MemberData> callback) {
        ...
        ApiClient.getClient().create(APIService.class)
                ...
                .enqueue(new Callback<PageSearchResponse>() {
                    ...
                    public void onResponse(Call<PageSearchResponse> call, Response<PageSearchResponse> response) {
                        progressLiveStatus.postValue(Constants.LOADED);
                        if (response.body() != null && response.body().getData().getUserData() != null) {
                            callback.onResult(response.body().getData().getUserData(), params.key + 1);
                        }
                    }
