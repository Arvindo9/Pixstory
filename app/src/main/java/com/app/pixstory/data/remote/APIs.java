...
public final class APIs implements APIService {
    private static APIService apis;

    private APIs() {
    }

    public static APIService setup(Context context) {
        apis = APIConfig.provideRetrofit(
                APIConfig.provideGson(),
                APIConfig.provideOkhttpClient(
                        APIConfig.provideCache(context)
                )
        )
    ...
    public Flowable<AccessRequest> signup(String signType, String firstName, String lastName, String userName,
                                          ...
                                          String password, String confirmPassword, String emailVerified, String deviceId, String platform, String countryCode,
    ...
    public Flowable<SupportResponse> addNotes(String token, int story_id) {
        return addNotes(token, story_id);
    }
    ...
    @Override
    public Flowable<AccessRequest> setPreferences(String token, int yourProfileActivity, int yourProfileActivityType,
                                                  int myProfileActivity, int allowMessage, int allowMessageType,
                                                  int helpOther, int[] interestIsd) {
