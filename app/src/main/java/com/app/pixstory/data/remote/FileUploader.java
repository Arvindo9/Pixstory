...
public class FileUploader {
    ...
    public void uploadFiles(String unique_key, String filekey,File[] files, String token, FileUploaderCallback fileUploaderCallback){
        uploadFiles(unique_key, filekey,files,fileUploaderCallback,token);
    }

    public void uploadFiles(String unique_key, String filekey,File[] files, FileUploaderCallback fileUploaderCallback,String auth_token){
    ...
    private void uploadSingleFile(final int index){
        ...
        if(auth_token.isEmpty()){
            ...
            call  = uploadInterface.uploadFile(unique_key, filePart, auth_token);
        }
