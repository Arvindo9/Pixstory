 ...
 */
public class BaseLinearPhotoInterest extends LinearLayoutCompat {
    @LayoutRes
    private int layout;
    @LayoutRes
    ...
    private BaseLinearPhotoInterest.CallBack callback;
    ...
    public interface CallBack{
        ...
        void onBaseCalendarIconClick(View currentView, View lastView, Interest model);
    }

    public void setListener(BaseLinearPhotoInterest.CallBack callback){
        this.callback = callback;
    }

    public BaseLinearPhotoInterest(Context context) {
        super(context);
        init(context, null);
        list = new ArrayList<>();
    }

    public BaseLinearPhotoInterest(Context context, AttributeSet attrs) {
        super(context, attrs);
        getAttributes(attrs);
        init(context, attrs);
        list = new ArrayList<>();
    ...
    public BaseLinearPhotoInterest(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void addItems(List<Interest> model) {
        list.clear();
        list.addAll(model);
        onItemUpdates();
    }
