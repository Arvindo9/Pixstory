 ...
 * {@link com.linkedin.platform.LISession#isValid()} should be used to validate the prefs before
...
public class LISessionManager {
    ...
    /**
     * Clears the prefs.  Calls to retrieve LinkedIn data or to view profiles will no longer
     * work.
     */
     ...
     * takes are of saving and restoring prefs to/from shared preferences
     */
